...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-white text-neutral-900 flex flex-col rounded-2xl border border-neutral-200 shadow-sm",
        className
      )}
      {...props}
    />
...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "grid auto-rows-min grid-rows-[auto_auto] items-start gap-2 px-6 py-5",
        className
      )}
      {...props}
    />
